...
var
  op: instyp;
  p: lvltyp;
  q, q1: address; { instruction register }
begin
...
begin
  ...
  begin
    ...
    Write('addr: ');
    wrthex(ad, maxdigh); Write(': ', Abs(l): 6, ': ');
    if l >= 0 then
      Writeln('free')
    else
      Writeln('alloc');
